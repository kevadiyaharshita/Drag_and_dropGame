...
import 'package:darg_and_drop_game/utils/fruits_utils.dart';
...
class _FruitsPageState extends State<FruitsPage> {
  ...
  void initState() {
    ...
    super.initState();
    index = r.nextInt(allFruits.length);
          ...
          children: [
                      ...
                      return Stack(
                        ...
                        children: [
                          Container(
                            ...
                            width: 180,
                            child: Image.asset(
                              'assets/images/fruits/${allFruits[index]}.png',
                            ),
                          ),
                          Container(
                            height: 190,
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "Score : ${fruitScore.toString().padLeft(2, '0')}",
                    style: TextStyle(
                        fontSize: 28,
