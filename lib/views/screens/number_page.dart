...
import 'package:darg_and_drop_game/utils/number_utils.dart';
...
class _NumberPageState extends State<NumberPage> {
  ...
  void initState() {
    ...
    super.initState();
    index = r.nextInt(allNumbers.length);
          ...
          children: [
                  ...
                  child: DragTarget(
                      ...
                      return Stack(
                        ...
                        children: [
                          Container(
                            ...
                            width: 180,
                            child: Image.asset(
                              'assets/images/numbers/${allNumbers[index]}.png',
                            ),
                          ),
                          Container(
                            height: 190,
                    ...
                    onWillAccept: (data) {
                      if (data == allNumbers[index]) {
                        ...
                        numberScore = numberScore - 5;
                        openSongs(path: 'assets/audio/negative_beeps-6008.mp3');
                      }
                      setState(() {});
                      return data == allNumbers[index];
                    },
                    onAccept: (data) {
                      setState(
                        () {
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "Score : ${numberScore.toString().padLeft(2, '0')}",
                    style: TextStyle(
                        fontSize: 28,
