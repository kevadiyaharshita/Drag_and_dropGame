...
import 'package:darg_and_drop_game/utils/animals_utils.dart';
...
class _AnimalPageState extends State<AnimalPage> {
  ...
  void initState() {
    ...
    super.initState();
    index = r.nextInt(allAnimal.length);
          ...
          children: [
              ...
              children: [
                Container(
                  ...
                  child: DragTarget(
                      ...
                      return Stack(
                        ...
                        children: [
                          Container(
                            ...
                            width: 180,
                            child: Image.asset(
                              'assets/images/animals/${allAnimal[index]}.png',
                            ),
                          ),
                          Container(
                            height: 190,
                    ...
                    onWillAccept: (data) {
                      if (data == allAnimal[index]) {
                        Vibration.vibrate(
                          pattern: [500, 500],
                        );
                        animalScore = animalScore + 10;
                        openSongs(
                            path:
                        ...
                        animalScore = animalScore - 5;
                        openSongs(path: 'assets/audio/negative_beeps-6008.mp3');
                      }
                      setState(() {});
                      return data == allAnimal[index];
                    },
                    onAccept: (data) {
                      setState(
                        () {
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "Score : ${animalScore.toString().padLeft(2, '0')}",
                    style: TextStyle(
                        fontSize: 28,
