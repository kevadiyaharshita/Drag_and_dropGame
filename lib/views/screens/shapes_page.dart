...
import 'package:darg_and_drop_game/utils/shapes_utils.dart';
...
class _ShapesPageState extends State<ShapesPage> {
  ...
  void initState() {
    ...
    super.initState();
    index = r.nextInt(allShapes.length);
          ...
          children: [
              ...
              children: [
                Container(
                  ...
                  child: DragTarget(
                      ...
                      return Stack(
                        ...
                        children: [
                          Container(
                            ...
                            width: 180,
                            child: Image.asset(
                              'assets/images/shapes/${allShapes[index]}.png',
                            ),
                          ),
                          Container(
                            height: 190,
                    ...
                    onWillAccept: (data) {
                      if (data == allShapes[index]) {
                        Vibration.vibrate(
                          pattern: [100, 100],
                        );
                        shapesScore = shapesScore + 10;
                        openSongs(
                            path:
                        ...
                        shapesScore = shapesScore - 5;
                        openSongs(path: 'assets/audio/negative_beeps-6008.mp3');
                      }
                      setState(() {});
                      return data == allShapes[index];
                    },
                    onAccept: (data) {
                      setState(
                        () {
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "Score : ${shapesScore.toString().padLeft(2, '0')}",
                    style: TextStyle(
                        fontSize: 28,
